                    ...
                    <tbody>
                        @forelse($donations as $donation)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.donation.edit', $donation->id) }}" class="btn btn-sm btn-warning">Edit</a>
                                    <form action="{{ route('admin.donation.destroy', $donation->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure?');">
                                        @csrf
                                        @method('DELETE')
