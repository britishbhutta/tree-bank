                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" id="donation_number" name="donation_number" class="form-control"
                                    value="{{ old('donation_number', $donationNumber) }}" readonly>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select id="ws_id" name="ws_id" class="form-control">
                                    ...
                                    @foreach ($workshops as $workshop)
                                        <option value="{{ $workshop->id }}" {{ old('ws_id') == $workshop->id ? 'selected' : '' }}>
                                            {{ $workshop->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select id="fund_type" name="fund_type" class="form-control" {{ old('type') == 'Trees' ? 'disabled' : '' }}>
                                    <option value="">Select Fund Type</option>
                                    <option value="Cash" {{ old('fund_type') == 'Cash' ? 'selected' : '' }}>Cash</option>
                                    <option value="Cheque" {{ old('fund_type') == 'Cheque' ? 'selected' : '' }}>Cheque</option>
                                </select>
                            </div>
