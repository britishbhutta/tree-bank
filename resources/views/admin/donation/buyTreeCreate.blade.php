...
.tree-item strong {
    ...
    <script>
        ...
        flowSelect.addEventListener('change', () => {
            ...
            }else if(flowSelect.value === 'Out'){
                document.getElementById('user_label').innerText = 'Donation To';
            }else if(flowSelect.value === 'In'){
                document.getElementById('user_label').innerText = 'Donor';
            }else {
                if (!typeSelect.querySelector('option[value="Funds"]')) {
                    typeSelect.add(fundsOption);
                }
            }
        });
