...
<main class="content-page">
    <div class="content mt-4">
        <div class="container-fluid">
            <div class="card">
                <div class="card-body">
                    <h4 class="fw-bold mb-4 border-bottom pb-2">Edit Tree Name</h4>
                    ...
                    <form method="POST" action="{{ route('admin.tree_names.update', $treeName->id) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="tree_type_id" id="tree_type_id" class="form-control" required>
                                ...
                                @foreach ($treeTypes as $type)
                                    <option value="{{ $type->id }}" {{ $treeName->tree_type_id == $type->id ? 'selected' : '' }}>
                                        {{ $type->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="name" name="name" class="form-control" value="{{ $treeName->name }}" required>
                        </div>

                        <div class="mb-3">
                            <label for="description" class="form-label">Description</label>
                            <textarea id="description" name="description" class="form-control">{{ $treeName->description }}</textarea>
                        </div>
